            ...
            <div className="hidden lg:block">
              ...
              <div>
                ...
                <div className="bg-[#FFFFFF] px-[65px] py-[24px] rounded-[18.47px] border-2 border-[#EFF0F6] text-center mt-[76px]">
                  ...
                  <button
                    className="text-[27px] font-extrabold text-[#FFFFFF] px-[27px] py-[21px] bg-[#D1A84B] rounded-[20px] mb-[34px]"
                    onClick={() => (window.location.href = "/AnalyticsP")}
                  >
                    Analitoikani diagramma yordamida ko’rish
                  </button>
                </div>
                <div className="bg-[#FFFFFF] px-[65px] py-[24px] rounded-[18.47px] border-2 border-[#EFF0F6] text-center mt-[76px]">
                  ...
                  <button
                    className="text-[27px] font-extrabold text-[#FFFFFF] px-[27px] py-[21px] bg-[#D1A84B] rounded-[20px] mb-[34px]"
                    onClick={() => (window.location.href = "/Pic_Table")}
                  >
                    Qarzlarni ko'rish
                  </button>
                </div>
